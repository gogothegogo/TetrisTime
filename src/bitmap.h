...
static const Bitmap s_cro_marked_weekdays[] = {
    { 6, 5,
      " #  # "
      " ## # "
      " # ## "
...
STATIC_ASSERT(ARRAY_SIZE(s_cro_marked_weekdays) == 9);
...
static const Bitmap s_cro_weekdays[] = {
    {
        12, BMP_SMALL_HEIGHT,
        "#  # ### ## "
        "## # #   # #"
...
STATIC_ASSERT(ARRAY_SIZE(s_cro_weekdays) == 7);

/* large months and days
